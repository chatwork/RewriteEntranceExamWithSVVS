...
public struct ChatworkAPIEndpoint {
    static private let meEndpoint = "https://api.chatwork.com/v2/me"
    
    public static var getMeEndpoint: URL {
    ...
    public static var getRoomsEndpoint: URL {
        return URL(string: roomsEndpoint)! // swiftlint:disable:this force_unwrapping
    }
    
    public static func getRoomMessageEndpoint(roomId: Int) -> URL {
